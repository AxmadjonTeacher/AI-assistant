...
SWAN_COMMAND_INSTRUCTION = (
    ...
    "2. Agent mavjud barcha 3D obyektlarni 100% butun saqlab qoladi (hech qanday mesh o'chirilmaydi!) yoki berilgan logoni 2D Curve, Linear RGB materiallar, studio yoritgichlari va Hollywood kamera harakati bilan 3D modelga aylantiradi. "
