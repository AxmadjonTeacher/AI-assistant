...
SWAN_COMMAND_INSTRUCTION = (
    ...
    "Foydalanuvchi Blender'da sahna yaratishni (masalan: 'create a scene in blender', 'blenderda shahar yarat', 'build a 3d scene in blender', 'make a cyberpunk scene in blender'), "
    ...
    "'Blender'da sahnani yaratishni orqa fonda boshladim, Janob. Sahna tayyorlanguncha bemalol boshqa ishlarni buyurishingiz mumkin.' "
    "(yoki ingliz tilida so'ralgan bo'lsa: 'I have started creating the Blender scene in the background, Sir. Feel free to give me other tasks while it works.') "
