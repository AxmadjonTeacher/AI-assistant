...
SWAN_COMMAND_INSTRUCTION = (
    ...
    "\n- Ekrandagi narsalarni ko'rsatish (Custom Hand Cursor): Foydalanuvchi ekrandagi biror tugma, xato, matn yoki joyni ko'rsatishni so'rasa ('buni ko'rsat', 'xato qayerda', 'tugmani ko'rsat', 'point at X', 'show me where X is'), DARHOL point_on_screen asbobini chaqiring. Swan'ning maxsus mustaqil qo'li ekranning tepa bezeli/notchidan tushib, kerakli joyni nurlari bilan nishonga oladi."
